      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-50 mb-6">
            <FaNewspaper className="text-2xl text-[#FF4242]" />
          </div>
          
          <h1 className="text-3xl md:text-4xl font-bold text-[#212121] mb-4">
            Blog de l'Auto-École Fiat 500
          </h1>
          
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Découvrez nos articles, conseils et actualités sur la conduite, le permis et nos Fiat 500
          </p>
